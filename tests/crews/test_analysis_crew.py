...
class TestAnalysisCrewTasks:
    """Tests for Analysis Crew task configuration."""

    def test_crew_has_correct_number_of_tasks(self):
        """Analysis Crew should have exactly 2 tasks."""
        crew = create_analysis_crew()
...
class TestAnalysisCrewToolAssignments:
    """Tests for tool assignments on Analysis Crew agents."""
...
class TestAnalysisCrewConsistency:
    ...
    def test_crew_is_reproducible(self):
        ...
        crew1 = create_analysis_crew()
        crew2 = create_analysis_crew()
